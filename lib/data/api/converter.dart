...
class CommonJsonSerializableConverter extends chopper.JsonConverter {
  ...
  chopper.Response<ResultType> convertResponse<ResultType, Item>(
    ...
    //Конвертнул в UTF8
    final jsonResUtf8 = response.copyWith<String>(body: utf8.decode(response.bodyBytes));
    final jsonRes = super.convertResponse(jsonResUtf8);

    return jsonRes.copyWith<ResultType>(
        body: ApiDataSource.commonJsonDecoder.decode<Item>(jsonRes.body) as ResultType);
  }
}
